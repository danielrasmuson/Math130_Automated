...
class MasterDatabase():
    ...
    def __init__(self, currentLab = "lab1"):
        ...
        self.wordQB = {
            ...
            1.4:{"question":"How much will both the total contributions and the final value after 30 years of her retirement account increase?","answer":[u"Contribution Increase: $38,060.33|38060|38062|228362¦.5",u"Total Value Increase: $69,468.42|69468|69471|416810¦.5"],"reason":"We need to look at the total increase from the initial monthly contribution of $333.33 to $400.00, which gives the total contribution increase of $38,060.33 and the final value increase of $69,468.42.","aText":"Problem #2","points":4},
            2.1:{"question":"Determine the equivalent monthly compounded interest rate (in decimal form with five decimal places) for the Inflation-Linked Bonds account (as in the first question in Problem #1).","answer":["r=0.06521|.0652"],"reason":"Solving the same equation as in problem #1 but with our APY = 0.0672.\n0.0672 = (1 + r/12)^12-1\n1.0672 = (1 + r/12)^12\n(1.0672)^(1/12) = 1 + r/12\n(1.0672)^(1/12) - 1 = r/12\n12[(1.0672)^(1/12) - 1]=r\nr=0.06521","aText":"2. (3)","points":2},
        ...
        self.excelQB = {
            ...
            "lab8":{
            2.3:{"sheet":"Exercise Template","cells":[["C3",120],["C4",0.04208],["E3",1.035],["G3",180],["G4",0.0652],["G5",0.00543],["I3",1.035],["B10",120],["B11",240.42],["F10",180],["F11",360.978],["J9",300],["J10",601.39],["D129",169.27],["H129",253.9]]}
            }
        }
